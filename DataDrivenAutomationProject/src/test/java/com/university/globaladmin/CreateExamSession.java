...
public void createExamSession(HashMap<String, String>data){
		
		ExcelReader excel = new ExcelReader(Constants.UNIVERSITY_PATH_SUITE1);
		CommonUtils.checkExecution("GlobalAdmin", "createExamSession", data.get(Constants.TESTCASE_COL_RUNMODE), excel);
