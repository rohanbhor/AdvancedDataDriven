...
public class CreateInstructorLedContent {
	
	@Test(dataProviderClass=DataProviders.class, dataProvider="getDataGlobalAdmin")	
	public void createInstructorLedContent(HashMap<String, String>data){
		
		ExcelReader excel = new ExcelReader(Constants.UNIVERSITY_PATH_SUITE1);
		CommonUtils.checkExecution("GlobalAdmin", "createInstructorLedContent", data.get(Constants.TESTCASE_COL_RUNMODE), excel);
